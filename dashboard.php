...
<body>
    ...
    .slider-katalog {
        display: flex;
        overflow-x: auto;
        /* Untuk membuatnya dapat digulir */
        scrollbar-width: none;
        /* Untuk menyembunyikan scrollbar pada browser */
        -ms-overflow-style: none;
        /* Untuk menyembunyikan scrollbar pada Internet Explorer */
    }

    .slider-katalog::-webkit-scrollbar {
        display: none;
        /* Untuk menyembunyikan scrollbar pada browser WebKit */
    }
    ...
    <section class="content-1 d-flex">
        <div class="container">
            ...
            <div class="container align-items-center text-center">
                <div class="row border-bottom border-black pt-2 justify-content-center">
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2 p-0 fs-5">
                        <a href="vitamin.html">Vitamin</a>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2 p-0 fs-5">
                        <a href="cek-gula.html">Cek Gula</a>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2 p-0 fs-5">
                        <a href="obesitas.html">Obesitas</a>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2 p-0 fs-5">
                        <a href="jantung.html">Jantung</a>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2 p-0 fs-5">
                        <a href="pola-diet.html">Pola diet</a>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2 p-0 fs-5">
                        <a href="pola-istirahat.html">Pola Istirahat</a>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2 p-0 fs-5">
                        <a href="olahraga.html">Olahraga</a>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2 p-0 fs-5">
                        <a href="kulit.html">Kulit</a>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2 p-0 fs-5">
                        <a href="gizi.html">Gizi</a>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2 p-0 fs-5">
                        <a href="mental.html">Kesehatan Mental</a>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2 p-0 fs-5">
                        <a href="kanker.html">Kanker</a>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2 p-0 fs-5">
                        <a href="pencernaan.html">Pencernaan</a>
                    </div>
                ...
                <div id="carouselExample" class="carousel slide mt-5">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img src="./content/assets/jantung.jpeg" class="d-block w-100" alt="..." />
                        </div>
                        <div class="carousel-item">
                            <img src="./content/assets/olahraga.jpeg" class="d-block w-100" alt="..." />
                        </div>
                        <div class="carousel-item">
                            <img src="./content/assets/hidup.jpeg" class="d-block w-100" alt="..." />
                        </div>
                    </div>
                                ...
                                <div class="row g-2">
                                    <div class="col-12 col-md-6">
                                        <div class="p-3 text-center">
                                            <img src="diet.jpeg" alt="" class="img-fluid" />
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="p-3">
                                            ...
                                            <a href="mental.html" class="">baca selengkapnya</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="p-3 border border-dark text-start">
                                <div class="row g-2">
                                    <div class="col-12 col-md-6">
                                        <div class="p-3 text-center">
                                            <img src="gula-darah.jpeg" alt="" class="img-fluid" />
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="p-3">
                                            ...
                                            <a href="kulit.html" class="">baca selengkapnya</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="p-3 border border-dark text-start">
                                <div class="row g-2">
                                    <div class="col-12 col-md-6">
                                        <div class="p-3">
                                            <img src="hidup.jpeg" alt="" class="img-fluid" />
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="p-3">
                                            ...
                                            <a href="pencernaan.html" class="">baca selengkapnya</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="p-3 border border-dark text-start">
                                <div class="row g-2">
                                    <div class="col-12 col-md-6">
                                        <div class="p-3">
                                            <img src="jantung.jpeg" alt="" class="img-fluid" />
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="p-3">
                                            ...
                                            <a href="kanker.html" class="">baca selengkapnya</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="p-3 border border-dark text-start">
                                <div class="row g-2">
                                    <div class="col-12 col-md-6">
                                        <div class="p-3">
                                            <img src="olahraga.jpeg" alt="" class="img-fluid" />
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="p-3">
                        ...
                        <div class="col-12 my-2">
                            <div class="p-3 border border-dark text-start">
                                <div class="row g-2">
                                    <div class="col-12 col-md-6">
                                        <div class="p-3">
                                            <img src="vitamin.jpeg" alt="" class="img-fluid" />
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="p-3">
